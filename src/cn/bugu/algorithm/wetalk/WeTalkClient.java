...
import static cn.bugu.algorithm.wetalk.WeTalkUtils.recvMsg;
import static cn.bugu.algorithm.wetalk.WeTalkUtils.sendMsg;
...
public class WeTalkClient {
    ...
    public static void main(String[] args) throws IOException {
        new WeTalkClient("localhost", 8012).start();
    }
}